          ...
          <div class="flex-shrink-0 px-2 py-4 space-y-2">
            <button
              ...
              class="
                ...
                hover:bg-blue-700
                focus:outline-none
                focus:ring focus:ring-blue-700 focus:ring-offset-1 focus:ring-offset-white
      ...
      <div class="flex flex-col flex-1 min-h-screen overflow-x-hidden overflow-y-auto">
        ...
        <header class="relative bg-white dark:bg-darker">
          <div class="flex items-center justify-between p-2 border-b dark:border-blue-800">
            ...
            <!-- Brand -->
            <a href="#" class="inline-block text-2xl font-bold tracking-wider text-blue-700 uppercase dark:text-light"> E-PMBOK </a>
